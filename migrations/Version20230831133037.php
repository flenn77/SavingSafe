 ...
 */
final class Version20230831133037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE used_space used_space INT NOT NULL, CHANGE total_space total_space INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE used_space used_space INT DEFAULT NULL, CHANGE total_space total_space INT DEFAULT NULL');
    }
}
